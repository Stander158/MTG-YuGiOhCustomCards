...
--sharing that number fights it.
function MTG.BonusFlag(code)
	return 0x9a570100 + (code % 100)
end

function MTG.BonusAvailable(tp,code)
	return Duel.GetFlagEffect(tp,MTG.BonusFlag(code))==0
end
